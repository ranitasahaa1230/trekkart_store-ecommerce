...
export function Home() {
  const { collections: {jackets, travelbags, hikingbags, boots}} = landingPageImages;
  const { brands: {bianyo, arnisa, celine, gucci}} = landingPageImages;
  const { review: {john, lara, mohit}} = landingPageImages;
     ...
     <div className="products-containerbox">
        <div className="product-box">
          ...
          <div className="content-product">
            ...
            <Link to="./pages/products.html" className="btns">Explore More</Link>
          </div>
        </div>
